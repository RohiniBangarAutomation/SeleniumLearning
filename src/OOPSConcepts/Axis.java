...
public class Axis extends RBI {
	...
	public void Home_Loan() {
		System.out.println("Home loan amount of your Axis account is:" + LoanAmount);
	}

	public void CalcInterestRate() {
		InterestAmount = LoanAmount * (InterestRate / 100);
		System.out.println("Interest rate of your Axis account home loan is " + InterestRate + "%");
		System.out.println("Yearly Interest of your Axis bank account home loan is: " + InterestAmount);
